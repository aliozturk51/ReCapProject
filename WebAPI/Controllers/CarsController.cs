...
namespace WebAPI.Controllers
{
    ...
    public class CarsController : ControllerBase
    {
        ...
        [HttpGet("getbycarsbrandid")]
        public IActionResult GetByCarsBrandId(int brandId)
        {
            var result = _carService.GetByCarsBrandId(brandId);
            if (result.Success)
            {
                return Ok(result);
            }
        ...
        [HttpGet("getbycarscolorid")]
        public IActionResult GetByCarsColorId(int colorId)
        {
            var result = _carService.GetByCarsColorId(colorId);
            if (result.Success)
            {
                return Ok(result);
            }
